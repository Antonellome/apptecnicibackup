...
export const rapportinoConverter: FirestoreDataConverter<Rapportino> = {
    ...
    fromFirestore: (snapshot: QueryDocumentSnapshot, options: any): Rapportino => {
        ...
        const rapportino: Rapportino = {
            ...
            veicoloId: rawData.veicoloId || '',
            naveId: rawData.naveId || '',
            luogoId: rawData.luogoId || '',
            ...
            includeTrasferta: rawData.includeTrasferta === true,
            trasfertaId: rawData.trasfertaId || '',
            firmaFirmatarioNome: rawData.firmaFirmatarioNome || '',
            firmaFirmatarioSocieta: rawData.firmaFirmatarioSocieta || '',
            firmaVettoriale: rawData.firmaVettoriale || '',
            ...
            isLocked: rawData.isLocked === true,
            isMultiDay: rawData.isMultiDay === true,
            tecnicoScriventeId: rawData.tecnicoScriventeId || '',
            clienteId: rawData.clienteId || '',
            dittaId: rawData.dittaId || '',
            ordineLavoro: rawData.ordineLavoro || '',
            completed: rawData.completed === true,
            userId: rawData.userId || '',
            oreLavoro: rawData.oreLavoro || 0,
        };
