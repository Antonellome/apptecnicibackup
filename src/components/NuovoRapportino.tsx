...
import { createRapportinoSchema } from '../models/rapportinoSchema';
...
const NuovoRapportino: React.FC<RapportinoFormProps> = ({ onClose, rapportino, currentTecnico, initialDate }) => {
