...
// --- COMPONENTE DIALOGO DI VISUALIZZAZIONE REFACTORED ---
...
// --- Componente Interno per la logica del Dialog ---
const InnerRapportinoView = ({ rapportinoId, onClose }: { rapportinoId: string, onClose: () => void }) => {
...
const RapportinoViewDialog = ({ open, onClose, rapportinoId }: { open: boolean, onClose: () => void, rapportinoId: string | null }) => {
    return (
        <Dialog open={open} onClose={onClose} fullWidth maxWidth="md">
            {/* La key forza il re-mount, resettando lo stato interno */}
            {open && rapportinoId && <InnerRapportinoView rapportinoId={rapportinoId} onClose={onClose} key={rapportinoId} />}
        </Dialog>
    );
};
